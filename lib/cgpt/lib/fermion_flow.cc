...
EXPORT(Fermionflow_fixedstepsize_mspincolor,{
    ...
    PVector<LatticePropagatorD> chi_in; //using PVector is a dirty hack, only ever need one LatticePropagatorD input
    LatticePropagatorD chi_out(grid);
    ...
    if (do_improved) {
      FermionFlow<PeriodicGimplR,ZeuthenAction<PeriodicGimplR>,LatticePropagatorD> ZF(epsilon,Nstep,U,meas_interval,Nckpoints);
      ...
      FermionFlow<PeriodicGimplR,WilsonGaugeAction<PeriodicGimplR>,LatticePropagatorD> WF(epsilon,Nstep,U,meas_interval,Nckpoints);
    ...
    auto tmp = new cgpt_Lattice<iSpinColourMatrix<vComplexD> >(grid_chi);
    tmp->l = chi_out;
    chi_flow = tmp;
...
EXPORT(Fermionflow_fixedstepsize_vspincolor,{
...
EXPORT(Fermionflow_fixedstepsize_adjoint_mspincolor,{
    ...
    LatticePropagatorD chi_out(grid);
    auto grid_chi = chi_out.Grid();
    LatticePropagatorD chi_tmp(grid);
...
EXPORT(Fermionflow_fixedstepsize_adjoint_vspincolor,{
